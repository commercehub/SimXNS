...
def main():
    ...
    if data_args.frequency_dict:
        logger.info("Load Frequency Dictionary from %s", data_args.frequency_dict)
        frequency_dict = json.load(open(data_args.frequency_dict))
    else:
        frequency_dict = None
